...
![alt text](./Imagens/Upload-para-bucket.png)
...
![alt text](./Imagens/permissoes-bucket.png)
...
![alt text](./Imagens/politica-de-bucket.png)
Aplicar uma Política (Exemplo de leitura pública para um arquivo específico):
![alt text](./Imagens/criando-politica-de-bucket.png)
...
![alt text](./Imagens/Ativar-versionamento.png)
...
![alt text](./Imagens/Versionamento-ativo.png)
...
![alt text](./Imagens/versoes-arquivo-s3.png)
...
![alt text](./Imagens/bucket-aba-de-gerenciamento.png)
...
![alt text](./Imagens/configuracao-de-politica-de-ciclo-de-vida-1.png)
...
![alt text](./Imagens/configuracao-de-politica-de-ciclo-de-vida-2.png)
